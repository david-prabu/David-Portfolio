  ...
  return (
    <div className="flex flex-row items-center">
      <a
        ...
        className="mr-5 transition-all bg-primary-500 hover:bg-primary-300 text-surface-100 font-bold py-2 px-5 rounded flex flex-row justify-center items-center"
      >
        <svg
